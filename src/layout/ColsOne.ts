...
export class ColsOne {
    ...
    constructor(private page: Properties, readonly y: number) {
        ...
        this.page.doc.roundedRect(this.page.margin, this.y, this.page.halfWidth, 123, this.page.cornerRadius).stroke(); // Cliente
    }

    ColsOne(data: Details['colsOne'], color: string = '#4C63ED') {
